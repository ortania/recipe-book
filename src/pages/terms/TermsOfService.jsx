    ...
    <div className={classes.page}>
      <div className={classes.container}>
        ...
        <section className={classes.section}>
          ...
          <p>
            האפליקציה מאפשרת לייבא מתכונים ממקורות חיצוניים (למשל קישור
            לאתר). מתכון שמיובא בדרך זו נשמר באפליקציה לשימוש אישי של
            המשתמש בלבד. אין לשתף מתכון מיובא בקהילה, או להפיצו לאחרים, אלא
            אם יש בידי המשתמש הרשאה מפורשת לכך מבעלי הזכויות. באחריות
            המשתמש לוודא כי כל תוכן שהוא משתף — לרבות שם מתכון, טקסט הקדמה,
            רשימת מצרכים, הוראות הכנה, תמונות וסרטונים — אינו מפר זכויות
            יוצרים, זכויות מוסריות או כל זכות אחרת של צד שלישי.
          </p>
          <p>
          ...
          <p>
            המשתמש מתחייב לשפות את בעלת האפליקציה בגין כל נזק, הוצאה או
            דרישה של צד שלישי הנובעים מתוכן שהעלה או שיתף בניגוד לתנאים
            אלו, לרבות טענות להפרת זכויות יוצרים.
          </p>
          <p>
        ...
        <section className={classes.section}>
          ...
          <p>
            בעלי זכויות הסבורים כי תוכן המופיע באפליקציה מפר את זכויותיהם
            מוזמנים לפנות אלינו בכתובת{" "}
            <a href="mailto:ortania@gmail.com" className={classes.email}>
              ortania@gmail.com
            </a>{" "}
            ולכלול בהודעה: זיהוי התוכן הנטען כמפר (קישור, שם מתכון או מזהה
            כלשהו), תיאור הזכות המופרת והיקפה, אישור כי הפונה הוא בעל
            הזכויות או מוסמך לפעול בשמם, וכן פרטי יצירת קשר. לאחר בחינה,
            האפליקציה רשאית להסיר את התוכן, להגביל את חשיפתו, להתרות במשתמש
            שהעלה אותו, או לחסום את חשבונו — לפי שיקול דעתה ובהתאם לחומרת
            ההפרה.
          </p>
          <p>
            משתמשים המעלים מתכונים מסכימים שהאפליקציה תפעל כאמור לעיל, ללא
            צורך באישור נוסף מהם, לצורך הגנה על זכויות של צדדים שלישיים.
          </p>
        </section>
